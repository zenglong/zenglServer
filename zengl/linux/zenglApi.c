...
ZL_EXPORT ZL_EXP_INT zenglApi_ReUse(ZL_EXP_VOID * VM_ARG,ZL_EXP_INT isClear)
{
	...
	VM->run.reg_list[ZL_R_RT_ARGTMP].val.dword = 0;
	VM->run.reg_list[ZL_R_RT_LOC].val.dword = 0;
	VM->run.reg_list[ZL_R_RT_ARG].val.dword = 0;
	VM->run.memblock_freeall_local(VM);
	VM->run.vstack_list.count = 0;
